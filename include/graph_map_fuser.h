...
public:
  ...
  virtual void ProcessFrame(pcl::PointCloud<pcl::PointXYZ> &cloud, Eigen::Affine3d &Tnow); //cloud is the current scan in robot frame,  Tnow is the current pose in world frame
